...
experience: "10 years",
email: "[robert.chen@example.com](mailto:robert.chen@example.com)",
...
experience: "8 years",
email: "[amanda.williams@example.com](mailto:amanda.williams@example.com)",
...
experience: "12 years",
email: "[james.wilson@example.com](mailto:james.wilson@example.com)",
appliedDate: "2025-01-12"
}]
const AdminDashboard = () => {
const { user } = useAuthStore()
const admin = user
return ( <div className="space-y-6"> <div className="flex flex-col md:flex-row justify-between items-start md:items-center"> <div> <h1 className="text-2xl font-bold text-gray-800">Admin Dashboard</h1> <p className="text-gray-600">Welcome back, {admin?.name}</p> </div> <div className="mt-4 md:mt-0">
<Button variant="primary" onClick={() => {}}>
System Settings </Button> </div> </div>
  {/* Dashboard Overview */}
